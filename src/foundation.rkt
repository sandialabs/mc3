...
(require (prefix-in smt. (file "foundation/smt.rkt")))
(provide (all-from-out (file "foundation/smt.rkt")))


(require (prefix-in sys. (file "foundation/systems.rkt")))
(provide (all-from-out (file "foundation/systems.rkt")))
